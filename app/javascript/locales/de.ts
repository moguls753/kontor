export default {
  ...
  recurring: {
    ...
    mark_ended: 'Beendet',
    mark_ended_hint: 'Läuft nicht mehr · kommt automatisch zurück, falls es erneut auftaucht',
    overdue: 'überfällig',
  ...
  statistics: {
    title: 'Statistiken',
    subtitle: 'Ausgaben, Einnahmen und Trends',
    empty_title: 'Keine Daten vorhanden',
    empty_description: 'Importiere Transaktionen, um Ausgabenmuster und Trends zu sehen.',
    no_data_period: 'Keine Aktivität in diesem Zeitraum.',
    data_from: 'Daten ab {{month}}',
    period: {
      this_month: 'Dieser Monat',
      last_month: 'Letzter Monat',
      m3: 'Letzte 3 Monate',
      m6: 'Letzte 6 Monate',
      m12: 'Letzte 12 Monate',
      ytd: 'Dieses Jahr',
    },
    tab: {
      networth: 'Vermögen',
    ...
    summary: {
      ...
      expenses: 'Ausgaben',
      net: 'Netto',
      per_month: 'Ø {{value}} / Mt.',
      savings_rate: 'Sparquote {{value}} %',
    },
    kpi: {
      savings_rate: 'Sparquote',
      avg_monthly_expenses: 'Ø Ausgaben / Mt.',
      fixed_costs: 'Fixkosten / Mt.',
      fixed_costs_so_far: 'Fixkosten / Mt. (bisher)',
    ...
    forecast: {
      ...
      scenario: {
        title: 'Szenario · Was-wäre-wenn',
        subtitle: 'Spiele bekannte Änderungen durch — rechnet obendrauf auf den typischen Monat.',
        add: 'Annahme hinzufügen',
        active: 'Szenario aktiv ({{n}})',
        reset: 'Zurücksetzen',
        kind_recurring: 'Wiederkehrend',
        kind_oneoff: 'Einmalig',
        group_kind: 'Art der Änderung',
        group_direction: 'Einnahme oder Ausgabe',
        group_mode: 'Neu oder Anpassen',
        mode_new: 'Neu',
        mode_adjust: 'Anpassen',
        item: 'Posten',
        current: 'aktuell',
        new_value: 'neuer Betrag',
        with_scenario: 'mit Szenario',
        income: 'Einnahme',
        expense: 'Ausgabe',
        savings: 'Sparen · nur Liquide',
        savings_hint: 'Geld aufs Depot/Sparkonto — mindert Liquide, nicht das Vermögen.',
        amount: 'Betrag',
        amount_ph: '0,00',
        label: 'Bezeichnung',
        label_ph: 'z. B. Gehaltserhöhung',
        from: 'ab',
        on: 'im',
        save: 'Hinzufügen',
        cancel: 'Abbrechen',
        remove: 'Entfernen',
        vs_baseline: 'ggü. Baseline bei {{months}} Mt.',
        empty: 'Noch keine Annahmen.',
      },
