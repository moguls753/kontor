export default {
  ...
  recurring: {
    ...
    section_outflows: 'Abos & Rechnungen',
    section_inflows: 'Einnahmen',
    section_contracts: 'Verträge & Abos',
    section_savings: 'Sparen & Transfers',
    savings_hint: 'Zwischen eigenen Konten — außerhalb der Fixkosten',
    monthly_sum: '≈ {{amount}}/Monat',
    summary_fixed: 'Fixkosten',
    summary_income: 'Einnahmen',
    summary_net: 'Saldo',
    summary_per_month: 'pro Monat',
    summary_mixed: 'gemischte Währungen',
    summary_title: 'Monatsübersicht',
    count_entries: '{{count}} Einträge',
    scan: 'Scannen',
