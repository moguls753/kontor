export default {
  ...
  recurring: {
    ...
    section_contracts: 'Verträge & Abos',
    section_sparen: 'Sparen',
    section_transfers: 'Transfers',
    sparen_hint: 'Auf Spar-/Anlagekonten oder gemeinsames Ansparen',
    transfers_hint: 'Reine Umbuchungen zwischen eigenen Konten',
    savings_neutral: 'Nur Umbuchungen',
    ...
    confirmed: 'Bestätigt',
    dismiss: 'Verwerfen',
    assign_category: 'Kategorie wählen',
