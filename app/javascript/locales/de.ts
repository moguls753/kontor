export default {
  ...
  statistics: {
    ...
    forecast: {
      ...
      flow_income: '+ {{value}} ein',
      flow_fixed: '− {{value}} fix',
      flow_variable: '− {{value}} var.',
      projected_net: '= {{value}} erwartetes Netto / Monat',
      projected_balance: 'In {{months}} Monaten: Saldo ~',
      upcoming: 'Anstehend (30 Tage)',
      empty_series: 'Noch keine wiederkehrenden Zahlungen erkannt.',
    },
  },
  settings: {
    title: 'Einstellungen',
