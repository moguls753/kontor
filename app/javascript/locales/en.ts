export default {
  ...
  recurring: {
    ...
    section_outflows: 'Subscriptions & Bills',
    section_inflows: 'Income',
    section_contracts: 'Contracts & Subscriptions',
    section_savings: 'Savings & Transfers',
    savings_hint: 'Between your own accounts — outside fixed costs',
    monthly_sum: '≈ {{amount}}/mo',
    summary_fixed: 'Fixed costs',
    summary_income: 'Income',
    summary_net: 'Net',
    summary_per_month: 'per month',
    summary_mixed: 'mixed currencies',
    summary_title: 'Monthly overview',
