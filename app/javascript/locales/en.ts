export default {
  ...
  recurring: {
    ...
    section_contracts: 'Contracts & Subscriptions',
    section_sparen: 'Savings',
    section_transfers: 'Transfers',
    sparen_hint: 'Into savings/investment accounts or shared saving',
    transfers_hint: 'Pure moves between your own accounts',
    savings_neutral: 'Own-account moves',
