export default {
  ...
  statistics: {
    ...
    forecast: {
      ...
      flow_income: '+ {{value}} in',
      flow_fixed: '− {{value}} fixed',
      flow_variable: '− {{value}} var.',
      projected_net: '= {{value}} expected net / month',
      projected_balance: 'In {{months}} months: balance ~',
      upcoming: 'Upcoming (30 days)',
      empty_series: 'No recurring payments detected yet.',
    },
  },
  settings: {
    title: 'Settings',
